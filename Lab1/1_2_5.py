...
def calculate_y():
    print("Lazy calculator: only for one function. Now there is a chance for mistake")
    
    while True:
        try:
            user_input = input("\nEnter value of x (in degrees) or 'exit': ").strip().lower()
            ...
            if x_deg < 1:
                ...
                # arcsin(x) - аргумент x_rad має бути в межах [-1, 1]
            ...
            if result is not None:
                ...
                print(f"Try again. Reason: {reason}")
